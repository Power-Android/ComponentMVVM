...
import com.power.common.constants.Constants
import com.power.common.http.HeaderUtils
import com.power.common.http.LoggerInterceptor
...
object HttpManager {
    ...
    fun init(context: Application) {
        ...
        val client: OkHttpClient = OkHttpClient.Builder()
            ...
            .addInterceptor(LoggerInterceptor.loggingIntercaptor) //
